...
export default function GenerateLongQuestionsScreen() {
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.header}>
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            ...
            <Text style={styles.headerTitle}>Long questions</Text>
          </View>
          <View style={{ width: 40 }} />
        </View>
        ...
        <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
          <View style={styles.panel}>
            <InputField
              ...
              placeholder="e.g. Thermodynamics, Organic reactions..."
              appearance="dark"
            />
            <InputField
              label="How many long questions?"
              value={numQuestions}
            ...
            <PrimaryButton
              title={loading ? 'Generating…' : 'Generate long questions'}
          ...
          {loading && (
            <View style={styles.loadingBox}>
              ...
              <Text style={styles.loadingTxt}>Generating detailed prompts…</Text>
              <Text style={styles.loadingSub}>
                Long answers need more model time; first server run can take several minutes. Keep this screen open.
              </Text>
            </View>
          )}
          ...
          {questions.length > 0 && !loading && (
            <View style={styles.results}>
              ...
              <Text style={styles.practiceHint}>
                Write your long answer in the box, submit for feedback, or reveal the model answer when you choose.
                Log in to submit.
              </Text>
              {questions.map((q, i) => (
...
const styles = StyleSheet.create({
  ...
  diffBtnOn: { borderColor: '#A78BFA', backgroundColor: 'rgba(139,92,246,0.15)' },
